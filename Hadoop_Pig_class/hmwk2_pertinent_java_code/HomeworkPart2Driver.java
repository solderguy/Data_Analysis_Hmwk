 ...
 *
 */
public class HomeworkPart2Driver {
  ...
  public static void main(String argv[]){
    ...
    try {
    	...
    	pgd.addClass("moviecountperactor", MovieCountPerActor.class, 
    			"A map/reduce program that counts # of movies for each major actor");
    	pgd.driver(argv);
    }
    catch(Throwable e){
      e.printStackTrace();
